...
function green_climate_header() {
  get_template_part( 'template-parts/header/site', 'header' );
}

function green_climate_listing_actus() { ?>
  <div class="inner bg-light" id="actualite">
    <div class="container">
    ...
    <div class="mt-4">
      <a href="<?php echo  get_post_type_archive_link( 'post' ) ?>" class="text-primary font-weight-bold">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#0a8e86" class="ml-2">
          <path d="M0 0h24v24H0V0z" fill="none"></path><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6-6-6z"></path>
        </svg>
      </a>
    </div>
  ...
  <?php
    ...
    echo '<p class="w-100 text-center">Aucun agenda à afficher</p>';
  endif;
  ?>
...
function green_climate_listing_agenda() { ?>
  <div class="inner" id="agenda">
    <div class="container">
  ...
  if ( $agenda-> have_posts() ) :
    ...
    <div class="col-sm-6 col-md-4 mb-4 pb-0">
      <div class="card border-0">
        <div class="card-header bg-blue d-flex align-items-center rounded-0">
...
function green_climate_shortcode() {
  add_shortcode( 'green_climate_header', 'green_climate_header' );
  add_shortcode( 'green_climate_listing_agenda', 'green_climate_listing_agenda' );
  add_shortcode( 'green_climate_listing_actus', 'green_climate_listing_actus' );
}

add_action('init', 'green_climate_shortcode');