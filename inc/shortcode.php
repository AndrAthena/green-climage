...
function green_climate_listing_agenda() {
  ...
  $output = '<div class="row agenda-list">';
  $args = array(
    'post_type'       => 'agenda',
    'posts_per_page'  => -1,
    'post_status'     => 'publish',
  ...
  if ( $agenda-> have_posts() ) {
    ...
    $output .= '<p class="w-100 text-center">Aucun agenda à afficher</p>';
  }
